...
# * https://github.com/samwhelp/note-about-herbstluftwm/blob/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-get/remote-install.sh
...
# * https://raw.githubusercontent.com/samwhelp/note-about-herbstluftwm/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-get/herbstluftwmrc-get
...
## $ export DEBUG_HERBSTLUFTWMRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_HERBSTLUFTWMRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="herbstluftwmrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-herbstluftwm/blob/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-get/herbstluftwmrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-herbstluftwm/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-get/herbstluftwmrc-get'


	THE_TARGET_FILE_NAME="herbstluftwmrc-get"
