...
is_debug () {
	if [ "$DEBUG_HERBSTLUFTWMRC_GET" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME='herbstluftwmrc-get'
	fi

	THE_CMD_FILE_PATH="${THE_CMD_DIR_PATH}/$THE_CMD_FILE_NAME"

	## https://github.com/samwhelp/note-about-herbstluftwm/blob/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-get/herbstluftwmrc-get
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-herbstluftwm/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-get/herbstluftwmrc-get'
	...
	## herbstluftwm
	THE_HERBSTLUFTWMRC_DIR_NAME="herbstluftwm"
	THE_HERBSTLUFTWMRC_DIR_PATH="$HOME/.config/$THE_HERBSTLUFTWMRC_DIR_NAME"

	THE_HERBSTLUFTWMRC_FILE_NAME="herbstluftwm.conf"
	THE_HERBSTLUFTWMRC_FILE_PATH="$THE_HERBSTLUFTWMRC_DIR_PATH/$THE_HERBSTLUFTWMRC_FILE_NAME"

	## herbstluftwmrc-profile
	THE_HERBSTLUFTWMRC_PROFILE_DIR_NAME="herbstluftwmrc-profile"
	THE_HERBSTLUFTWMRC_PROFILE_DIR_PATH="$HOME/.local/share/$THE_HERBSTLUFTWMRC_PROFILE_DIR_NAME"
...
base_var_dump () {
	...
	util_debug_echo "THE_HERBSTLUFTWMRC_DIR_NAME=$THE_HERBSTLUFTWMRC_DIR_NAME"
	util_debug_echo "THE_HERBSTLUFTWMRC_DIR_PATH=$THE_HERBSTLUFTWMRC_DIR_PATH"

	util_debug_echo "THE_HERBSTLUFTWMRC_FILE_NAME=$THE_HERBSTLUFTWMRC_FILE_NAME"
	util_debug_echo "THE_HERBSTLUFTWMRC_FILE_PATH=$THE_HERBSTLUFTWMRC_FILE_PATH"

	util_debug_echo "THE_HERBSTLUFTWMRC_PROFILE_DIR_NAME=$THE_HERBSTLUFTWMRC_PROFILE_DIR_NAME"
	util_debug_echo "THE_HERBSTLUFTWMRC_PROFILE_DIR_PATH=$THE_HERBSTLUFTWMRC_PROFILE_DIR_PATH"
