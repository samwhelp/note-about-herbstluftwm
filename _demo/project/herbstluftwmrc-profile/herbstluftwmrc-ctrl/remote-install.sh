...
# * https://github.com/samwhelp/note-about-herbstluftwm/blob/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-ctrl/remote-install.sh
# * https://github.com/samwhelp/note-about-herbstluftwm/blob/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-ctrl/herbstluftwmrc-ctrl
# * https://raw.githubusercontent.com/samwhelp/note-about-herbstluftwm/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-ctrl/herbstluftwmrc-ctrl
...
is_debug () {
	if [ "$DEBUG_HERBSTLUFTWMRC_CTRL_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="herbstluftwmrc-ctrl-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-herbstluftwm/blob/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-ctrl/herbstluftwmrc-ctrl
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-herbstluftwm/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-ctrl/herbstluftwmrc-ctrl'


	THE_TARGET_FILE_NAME="herbstluftwmrc-ctrl"
