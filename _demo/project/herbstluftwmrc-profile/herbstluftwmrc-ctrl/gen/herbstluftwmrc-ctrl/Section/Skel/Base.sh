...
is_debug () {
	if [ "$DEBUG_HERBSTLUFTWMRC_CTRL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME='herbstluftwmrc-ctrl'
	fi

	THE_CMD_FILE_PATH="${THE_CMD_DIR_PATH}/$THE_CMD_FILE_NAME"

	## https://github.com/samwhelp/play-ubuntu-20.04-plan/blob/master/project/herbstluftwmrc-profile/herbstluftwmrc-ctrl/herbstluftwmrc-ctrl
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-herbstluftwm/gh-pages/_demo/project/herbstluftwmrc-profile/herbstluftwmrc-ctrl/herbstluftwmrc-ctrl'
	...
	THE_HERBSTLUFTWMRC_FILE_NAME="autostart"
