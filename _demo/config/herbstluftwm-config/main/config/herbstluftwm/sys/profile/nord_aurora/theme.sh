...
nord_aurora_theme_setting () {
	...
	hc set frame_border_normal_color '#a3be8c'
	hc set frame_bg_active_color '#bf616a'
	hc set frame_bg_normal_color '#a3be8c'
	...
	hc attr theme.urgent.color '#b48ead'
	hc attr theme.active.color '#bf616a'
	hc attr theme.normal.color '#a3be8c'
	hc attr theme.title_color '#ffffff'
	hc attr theme.normal.title_color '#595959'
	...
	hc attr theme.urgent.inner_color '#b48ead'
	hc attr theme.active.inner_color '#bf616a'
	hc attr theme.normal.inner_color '#a3be8c'
